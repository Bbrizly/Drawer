...
let package = Package(
    ...
    products: [
        // The iOS companion consumes the exact parser/writeback/timer engine
        // used by the Mac app instead of maintaining a second task model.
        .library(name: "DrawerCore", targets: ["DrawerCore"]),
    ],
    dependencies: [
